...
urlpatterns = [
    ...
    path(LocalUser.type + '/<int:user_id>/' + Credential.type, login_required(CredentialView.as_view()), kwargs={'cred_id': None}),

    path(LocalUser.type + '/<int:user_id>/' + Credential.type + '/<int:cred_id>', login_required(CredentialView.as_view())),
