function JobView(job, headerContainer, resultContainer) {
    ...
    self.cancelButton = btnNavbarGlyph.clone()
        ...
        .click(function () {
            ...
            JobView.postData(self.job, 'kill');
    ...
    if (self.job.is_running) var intervalId = setInterval(function () {
        ...
        JobView.getData(self.job, 'get', function (data) {
...
JobView.getData = function (job, action, callback) {

    getData(job, paths.runnerApi + 'job/' + action + '/', callback);

};

JobView.postData = function (job, action, callback) {
                                        ...
                                        table.DataTable().rows().every(function () {
                                            ...
                                            $(rowApi.node()).css('cursor', 'pointer').off().click(function () {
                                                ...
                                                if (rowApi.child.isShown()) {
                                                    ...
                                                    JobView.getData(self.job, 'get_result', function (data) {
